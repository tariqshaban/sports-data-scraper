...
# HypothesisContainer.significant_difference_between_goalkeeper_and_player_height_2020()
# HypothesisContainer.significant_difference_between_forward_and_midfielder_players_goals_2020()
# HypothesisContainer.significant_difference_between_defender_and_midfielder_players_yellow_cards_2020()
# HypothesisContainer.significant_difference_between_attendance_2017_and_2020()
# HypothesisContainer.significant_difference_between_attendance_2010_and_2016()
HypothesisContainer.significant_difference_between_attendance_barcelona_and_real_madrid()
print('--------------------------------------------------')
print('Done.')
